...
class ContentProcessor:
    """
    Processes the parsed content - summarizes images, creates semantic chunks
    """
    def __init__(self, config):
        """
        Initialize the content processing.
    ...
    def chunk_document(self, formatted_document: str) -> List[str]:
        ...
        Args:
            ...
            model: OpenAI model instance (will create one if not provided)
